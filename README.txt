...
function for prediction This will generate a inference.c file, use it wherever necessary . A main.c file has been added for reference. Use input_generate_OCR to generate 
a file containing the variable data needed as input in inference.c 
