# -*- coding: utf-8 -*-
"""
Created on Thu Dec  9 13:50:43 2021
...
'''
#time series model to predict sin(x) is used here
model_name='sine.hdf5'
model=tf.keras.models.load_model(model_name)
'''
To perform quantization, sample inputs are mentioned
'''
datalist=(np.linspace(-6.28,6.28,10))#generate values from -2*pi to 2*pi
inp=[]
val=0
